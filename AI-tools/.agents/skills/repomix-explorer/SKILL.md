...
description: "Use this skill when the user wants to analyze or explore a codebase (remote repository or local repository) using Repomix. Triggers on: 'repomix' mentions only. Runs repomix CLI to pack repositories, then analyzes the output."
---
